...
tr:nth-child(even) {
  background-color: #dddddd;
	...
	<body>
		...
		<div class="section">
			...
			<div class="container">
				...
				<table>
					<tr> <th>Order Number </th> <th>Customer ID </th> <th> Order Date</th> <th> Shipped Date</th> <th> Total Bill</th> <th> Billing Date</th>  <th> Order Status</th>  </tr>
				<?php
	...
	while($row = mysqli_fetch_assoc($result))
	{
        ...
        echo "<tr>". "<th>". $orderID . "</th>". "<th>". $userID . "</th>"."<th>".$Orderdate. "</th>"."<th>".$ShippedDate. "</th>"."<th>".$TotalPrice. "</th>" ."<th>".$billingDate. "</th>"."<th>".$OrderStatus. "</th>" ."</tr>";
